...
- [x] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    It's a JavaScript Library. It tries to make UI's easier to make through components and managing states. These components are great because we can keep reusing them over the breadth of the site and even in other projects sometimes. 
- [x] What does it mean to _think_ in react?
     I can't find the term think as something react does. I am assuming it's about the way of thinking. The idea with react is that you should always be thinking in components. If you need something on your page, render a component. If that component needs something, render a component for it. This creates an organized tree that's easy to manipulated and change.
- [x] Describe state.
      State is a declaration of what a program looks like at a given time. You can change states and "react" to those changes. State can be used as a variable throughout a React app.
- [x] Describe props.
      Props are literally properties passed down from one parent to a child. You can chain props forever.
- [x] What are side effects, and how do you sync effects in a React component to state or prop changes?
      A side effect is something that happens with changes in state. We can use the "useEffect" hook to create side effects and use them.
